...
namespace label {
   ...
   */
  export const transform: (angularScale: d3.ScaleLinear<number, number>,
   ...
   */
  export const opacity: (d: d3.HierarchyRectangularNode<Node>,
                         angularScale: d3.ScaleLinear<number, number>,
                         radialScale: d3.ScaleLinear<number, number>,
                         labelLength: number,
   ...
   */
  export const anchor: (scale: d3.ScaleLinear<number, number>,
                        d: d3.HierarchyRectangularNode<Node>) => string
   ...
   */
  export const offset: (scale: d3.ScaleLinear<number, number>,
                        d: d3.HierarchyRectangularNode<Node>,
   ...
   */
  export const fontSize: (d: d3.HierarchyRectangularNode<Node>,
                          angularScale: d3.ScaleLinear<number, number>,
                          radialScale: d3.ScaleLinear<number, number>,
                          constraints: IStyleConstraints) => string
    = (d: d3.HierarchyRectangularNode<Node>,
...
namespace node {
  ...
  export const opacity: (d: d3.HierarchyRectangularNode<Node>,
    ...
    d.depth >= threshold
    ? constraint.fadedOpacity
    : constraint.visibleOpacity;
}
