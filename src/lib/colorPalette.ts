...
const sunburstColors: () => ScaleOrdinal<string, string> = (): ScaleOrdinal<
  string,
  string
> =>
  scaleOrdinal([
...
const sunburstColorsAlt: () => ScaleOrdinal<string, string> = (): ScaleOrdinal<
  string,
  string
> =>
    scaleOrdinal([
...
export { sunburstColors, sunburstColorsAlt };
